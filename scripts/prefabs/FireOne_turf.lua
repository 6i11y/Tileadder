...
local settileid = GROUND.FireOne --Set tile name in upper case after GROUND.
...
local data = {name = "FireOne_turf", anim = "carpet", tile = settileid} --set parameter name like "*tilename*_turf"
