...
local settileid = GROUND.EXAMPLEWHITE --Set tile name in upper case after GROUND.
...
local data = {name = "examplewhite_turf", anim = "carpet", tile = settileid} --set parameter name like "*tilename*_turf"
