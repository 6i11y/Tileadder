...
local settileid = GROUND.EXAMPLERED --Set tile name in upper case after GROUND.
...
local data = {name = "examplered_turf", anim = "carpet", tile = settileid} --set parameter name like "*tilename*_turf"
